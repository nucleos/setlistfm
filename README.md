...
[![Continuous Integration](https://github.com/nucleos/setlistfm/workflows/Continuous%20Integration/badge.svg?event=push)](https://github.com/nucleos/setlistfm/actions?query=workflow%3A"Continuous+Integration"+event%3Apush)
